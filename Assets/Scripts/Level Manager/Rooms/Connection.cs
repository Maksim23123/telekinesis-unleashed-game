...
public class Connection
{
    ...
    public BlockStructureData AttachedStructureData { get; set; }

    public Vector2Int GetConnectionPoint(BlockGridSettings blockGridSettings)
    {
        if (Orientation == Orientation.Left)
        {
            return PositionInGrid + Vector2Int.left * blockGridSettings.HorizontalExpandDirectionFactor * -1;
        }
        return PositionInGrid + Vector2Int.right * blockGridSettings.HorizontalExpandDirectionFactor * -1;
    }
